...
const Sidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    { name: 'Dashoboard', path: '/dashboard/home', permission: 'test' },
    { name: 'Document Config', path: '/dashboard/documents', permission: 'update' },
    { name: 'User Config', path: '/dashboard/config', permission: 'update' },
    { name: 'Profile', path: '/dashboard/profile', permission: 'update' },
    { name: 'Settings', path: '/dashboard/settings', permission: 'update' },
    { name: 'About Us', path: '/dashboard/aboutus', permission: 'read' },
